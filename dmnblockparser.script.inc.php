...
if ($response['http_code'] == 200) {
	...
	if ($mnpubkeys === false) {
		echo " Failed to JSON decode!\n";
		die(200);
	} elseif (!is_array($mnpubkeys) || !array_key_exists('data', $mnpubkeys) || !is_array($mnpubkeys['data']) || !array_key_exists('mnpubkeys', $mnpubkeys['data']) || !is_array($mnpubkeys['data']['mnpubkeys'])) {
		echo " Incorrect data!\n";
		die(202);
	}
...
if ($response['http_code'] == 200) {
	...
	if ($mndonations === false) {
		echo " Failed to JSON decode!\n";
		die(200);
	} elseif (!is_array($mndonations) || !array_key_exists('data', $mndonations) || !is_array($mndonations['data']) || !array_key_exists('mndonations', $mndonations['data']) || !is_array($mndonations['data']['mndonations'])) {
		echo " Incorrect data!\n";
		die(202);
	}
...
if ($response['http_code'] == 200) {
	...
	if ($poolpubkeys === false) {
		echo " Failed to JSON decode!\n";
		die(200);
	} elseif (!is_array($poolpubkeys) || !array_key_exists('data', $poolpubkeys) || !is_array($poolpubkeys['data']) || !array_key_exists('poolpubkeys', $poolpubkeys['data']) || !is_array($poolpubkeys['data']['poolpubkeys'])) {
		echo " Incorrect data!\n";
		die(202);
	}
...
if ($response['http_code'] == 200) {
	...
	if ($mnsuperblocks === false) {
		echo " Failed to JSON decode!\n";
		die(210);
	} elseif (!is_array($mnsuperblocks) || !array_key_exists('data', $mnsuperblocks) || !is_array($mnsuperblocks['data']) || !array_key_exists('budgetsexpected', $mnsuperblocks['data']) || !is_array($mnsuperblocks['data']['budgetsexpected'])) {
		echo " Incorrect data!\n";
		die(212);
	}
...
if ($response['http_code'] == 200) {
	...
	if ($mnsuperblocks2 === false) {
		echo " Failed to JSON decode!\n";
		die(210);
	} elseif (!is_array($mnsuperblocks2) || !array_key_exists('data', $mnsuperblocks2) || !is_array($mnsuperblocks2['data']) || !array_key_exists('superblocksexpected', $mnsuperblocks2['data']) || !is_array($mnsuperblocks2['data']['superblocksexpected'])) {
		echo " Incorrect data!\n";
		die(212);
	}
